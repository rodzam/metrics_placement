#!/usr/bin/python3
##############################################################
# Script name: St. Paul Pioneer Press (Site Scraper)
# Version: 2.0
# By: Rodrigo Zamith
...
pubshort = "spp"
puburl = "http://www.twincities.com/"
puburl_mobile = "http://www.twincities.com/"
puburl_mv = 1
...
if download_desktop == 1:
    try:
        ...
        if puburl_mv != None:
            scraperfunctions.load_homepage(browser, pubshort, "http://www.twincities.com/popular#pop-day")
            html_code = browser.page_source
