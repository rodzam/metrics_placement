#!/usr/bin/python3
##############################################################
# Script name: New York Times (Site Scraper)
# Version: 2.0
# By: Rodrigo Zamith
...
pubshort = "nyt"
puburl = "http://www.nytimes.com/"
puburl_mobile = "http://mobile.nytimes.com/"
puburl_mv = None
...
if download_desktop == 1:
    try:
        ...
        if puburl_mv_extraactions != None:
            browser.find_element_by_xpath("id('recommendations')//li[@data-type='most-viewed']").click()
