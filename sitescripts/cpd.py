#!/usr/bin/python3
##############################################################
# Script name: Plain Dealer (Site Scraper)
# Version: 2.0
# By: Rodrigo Zamith
...
pubshort = "cpd"
puburl = "http://www.cleveland.com/"
puburl_mobile = "http://www.cleveland.com/"
puburl_mv = None
puburl_mv_extraactions = 1
...
if download_desktop == 1:
    ...
    try:
        ...
        if puburl_mv_extraactions != None:
            browser.find_element_by_xpath("id('river_nav_inner')//li[@data-value='popular']").click()
            #time.sleep(5)
            #browser.find_element_by_xpath("id('river_nav_sub')//li[@data-value='day']").click()
            pass
