#!/usr/bin/python3
##############################################################
# Script name: San Jose Mercury News (Site Scraper)
# Version: 2.0
# By: Rodrigo Zamith
...
pubshort = "sjm"
puburl = "http://www.mercurynews.com/"
puburl_mobile = "http://www.mercurynews.com/"
puburl_mv = 1
...
if download_desktop == 1:
    try:
        ...
        if puburl_mv != None:
            scraperfunctions.load_homepage(browser, pubshort, "http://www.mercurynews.com/popular#pop-day")
            html_code = browser.page_source
