#!/usr/bin/python3
##############################################################
# Script name: The Denver Post (Site Scraper)
# Version: 2.0
# By: Rodrigo Zamith
...
pubshort = "dpo"
puburl = "http://www.denverpost.com/"
puburl_mobile = "http://www.denverpost.com/"
puburl_mv = 1
...
if download_desktop == 1:
    try:
        ...
        if puburl_mv != None:
            scraperfunctions.load_homepage(browser, pubshort, "http://www.denverpost.com/popular#pop-day")
            html_code = browser.page_source
